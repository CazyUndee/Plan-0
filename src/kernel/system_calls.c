...
/* 
 * NOTE: The syscall_table[] array was removed as dead code.
 * Real dispatch happens in syscall_handler() via the switch statement below.
 * The syscall_entry assembly stub calls syscall_handler() directly.
 */
